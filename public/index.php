    ...
    <div class="flex flex-wrap gap-10 ml-10">
      <div class="mt-1 relative w-60">
        <div class="flex flex-col mt-2 gap-5 fixed">
          ...
          <div class="flex items-center font-base text-xl text-gray-700 gap-4 p-2 rounded-full -mt-2 hover:bg-gray-200 cursor-pointer transition-all w-52"><svg viewBox="0 0 24 24" aria-hidden="true" class="w-8">
              <g>
      ...
      <div class="border-l border-r border-gray-100" style="width: 35em">
        ...
        <div class="mt-3 px-5 flex flex-col">
          ...
          <div class="flex mt-3 gap-1">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="w-5">
              <g>
                <path fill="#606060" d="M19.708 2H4.292C3.028 2 2 3.028 2 4.292v15.416C2 20.972 3.028 22 4.292 22h15.416C20.972 22 22 20.972 22 19.708V4.292C22 3.028 20.972 2 19.708 2zm.792 17.708c0 .437-.355.792-.792.792H4.292c-.437 0-.792-.355-.792-.792V6.418c0-.437.354-.79.79-.792h15.42c.436 0 .79.355.79.79V19.71z"></path>
                <circle fill="#606060" cx="7.032" cy="8.75" r="1.285"></circle>
                <circle fill="#606060" cx="7.032" cy="13.156" r="1.285"></circle>
                <circle fill="#606060" cx="16.968" cy="8.75" r="1.285"></circle>
                <circle fill="#606060" cx="16.968" cy="13.156" r="1.285"></circle>
                <circle fill="#606060" cx="12" cy="8.75" r="1.285"></circle>
                <circle fill="#606060" cx="12" cy="13.156" r="1.285"></circle>
                <circle fill="#606060" cx="7.032" cy="17.486" r="1.285"></circle>
                <circle fill="#606060" cx="12" cy="17.486" r="1.285"></circle>
              </g>
            </svg>
