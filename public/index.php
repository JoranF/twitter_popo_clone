    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 mt-1 sm:w-10/12">
      <div>
        <div class="flex flex-col mt-2 gap-4">
          ...
          <button class="bg-sky-500 font-medium w-6/12 py-3 text-white rounded-full text-lg transition-all hover:bg-sky-600">Tweeten</button>
        </div>
      </div>
